...
\begin{enumerate}[1.]
    \item \verbatiminput{../output/Q9-maximal-1.txt} 
    \item \verbatiminput{../output/Q9-maximal-2.txt} 
    \item \verbatiminput{../output/Q9-maximal-3.txt} 
    \item \verbatiminput{../output/Q9-maximal-4.txt} 
    \starreditem \verbatiminput{../output/Q9-maximal-5.txt} 
    \item \verbatiminput{../output/Q9-maximal-6.txt} 
    \item \verbatiminput{../output/Q9-maximal-7.txt} 
    \item \verbatiminput{../output/Q9-maximal-8.txt} 
    \starreditem \verbatiminput{../output/Q9-maximal-9.txt} 
    \item \verbatiminput{../output/Q9-maximal-10.txt} 
    \item \verbatiminput{../output/Q9-maximal-11.txt} 
    \starreditem \verbatiminput{../output/Q9-maximal-12.txt} 
    \starreditem \verbatiminput{../output/Q9-maximal-13.txt} 
    \item \verbatiminput{../output/Q9-maximal-14.txt} 
    \item \verbatiminput{../output/Q9-maximal-15.txt} 
    \item \verbatiminput{../output/Q9-maximal-16.txt} 
    \item \verbatiminput{../output/Q9-maximal-17.txt} 
    \item \verbatiminput{../output/Q9-maximal-18.txt} 
    \item \verbatiminput{../output/Q9-maximal-19.txt} 
    \item \verbatiminput{../output/Q9-maximal-20.txt} 
\end{enumerate}
\end{document}
